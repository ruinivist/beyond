                ...
                _section(
                  ...
                  cards: [
                    ...
                    const _GalleryCard(
                      ...
                      existing: false,
                      note:
                          'A pressed control reveals font and preset color '
                          'controls to its right.',
                      child: _TextSettingsPrototype(),
                    ),
                    _GalleryCard(
                      title: 'Code block',
                      existing: true,
...
class _TextSettingsPrototype extends StatefulWidget {
  const _TextSettingsPrototype();

  @override
  State<_TextSettingsPrototype> createState() => _TextSettingsPrototypeState();
}

class _TextSettingsPrototypeState extends State<_TextSettingsPrototype> {
  static const _palette = <(String, Color)>[
    ('Black', Color(0xff201c1a)),
    ('Gray', Color(0xff887b73)),
    ('White', Color(0xffffffff)),
    ('Red', Color(0xffdc3f3f)),
    ('Orange', Color(0xffff7626)),
    ('Yellow', Color(0xffffc936)),
    ('Green', Color(0xff4caf50)),
    ('Teal', Color(0xff45c7c4)),
    ('Blue', Color(0xff2f6fde)),
    ('Purple', Color(0xff7928e8)),
    ('Pink', Color(0xffdf267d)),
  ];

  final _colorMenu = MenuController();
  var _open = false;
  var _fontFamily = 'Source Serif 4';
  Color _color = _palette.first.$2;
        ...
        Container(
          ...
          child: Text(
            ...
            style: GoogleFonts.getFont(
              _fontFamily,
              textStyle: theme.typo.heading.copyWith(
                color: _color,
                fontSize: 30,
          ...
          children: [
            Tooltip(
              ...
              child: AnimatedContainer(
                ...
                child: IconButton(
                  key: const ValueKey('gallery-text-settings-button'),
            ...
            TweenAnimationBuilder<double>(
              ...
              child: Padding(
                ...
                child: Material(
                  key: const ValueKey('gallery-text-settings-panel'),
                                ...
                                children: [
                                  for (final swatch in _palette)
                                    Tooltip(
                                      ...
                                      child: Semantics(
                                        button: true,
                                        selected: _color == swatch.$2,
                                        label: 'Use ${swatch.$1.toLowerCase()}',
                                        child: IconButton(
                                          key: ValueKey(
                                            'gallery-color-${swatch.$1}',
                                          ),
                                          onPressed: () {
                                            setState(() => _color = swatch.$2);
                                            _colorMenu.close();
                                          },
                                          style: IconButton.styleFrom(
